		...
		<div id="myCarousel" class="carousel slide homCar">
            <div class="carousel-inner">
			  ...
			  <div class="item">
                ...
                <div class="carousel-caption">
                      <h4> Look good and feel awesome </h4>
                      <p><span>Be the better fashion of yourself.</span></p>
                </div>
              </div>
			  <div class="item active">
                <img style="width:100%" src="assets/img/carousel3.png" alt="bootstrap ecommerce templates">
                <div class="carousel-caption">
                      <h4> Make your order anytime anyday </h4>
                      <p><span>It is our pleasure to serve you.</span></p>
                </div>
              </div>
              <div class="item">
                <img style="width:100%" src="assets/img/bootstrap-templates.png" alt="bootstrap templates">
                <div class="carousel-caption">
                      <h4> Get sparkling and spend less </h4>
                      <p><span>You do not have to spend the whole world.</span></p>
                </div>
              </div>
            </div>
			  ...
			  <div class="thumbnail">
				...
				<div class="caption">
				  ...
				  <h4>
					  ...
					  <span class="pull-right"><?php echo $naira; ?>22.00</span>
				  </h4>
				</div>
			  </div>
			</li>
...
<section class="our_client">
	<hr class="soften"/>
	<h4 class="title cntr"><span class="text">Manufacturers</span></h4>
	<hr class="soften"/>
	<div class="row">
		<div class="span2">
